...
/***
 * 
 * @author Chenhua Zhu, Date 28/4/2016
 * 
 */
public class QuestionForLotum {

	public static void main(String[] args) {

		new QuestionForLotum().addFooBar();
		System.out.println();
		new QuestionForLotum().countEvenNum(8);
		System.out.println();
		new QuestionForLotum().removeDup();
		System.out.println();
		new QuestionForLotum().countRange();
		System.out.println();
		new QuestionForLotum().priByOneLoop();
		System.out.println();
		new QuestionForLotum().getSumAndIndex(new int[] { 1, 2, 4, 1, 5, 9, 7,
				8, 1 }, 3);
	}
